...
```{r loadData}
load("./data/Robjects/exampleProject/Annotated_Results_LvV.RData")
```
...
```{r}
load("./data/Robjects/exampleProject/mouse_H_v5.RData")
pathwaysH <- Mm.H
```
...
gt <- plotGseaTable(pathwaysH[topPathways], 
              rankData, 
              fgseaRes, 
              gseaParam = 0.5,
              render = TRUE)
# gridExtra::arrangeGrob(gt)
```
