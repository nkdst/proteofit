...
ggsave("./plots/02_euler.svg", p)
ggsave("./plots/02_euler.png", p)
```
...
# saving as .svg
svglite::svglite("./plots/02_heatmap_sign_genes.svg", width=6, height=6)
chm
dev.off()

# saving as .png
png("./plots/02_heatmap_sign_genes.png", width=6, height=6, units = "in", res = 1200)
chm
dev.off()
```
