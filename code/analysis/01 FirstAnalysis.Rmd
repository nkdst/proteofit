...
rlogcounts.gastroc.top <- DESeq2::rlog(as.matrix(counts.gastroc.top))

chm <- Heatmap(
    rlogcounts.gastroc.top,
    row_title = "genes",
    name = "rlog",
...
heatmap.2(DESeq2::rlog(as.matrix(counts.gastroc.top)), 
          col=rev(morecols(50)),
          trace="column", 
          main="Top 1000 most variable\n genes across samples",
          labRow = FALSE,
