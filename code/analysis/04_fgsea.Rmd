...
> the gastrocnemius gene count is about 300 over the one from the soleus. This
> is due to the significance cutoff during the `DESeq` analysis.
...
if (knitr::is_html_output()) {
  ...
  # interactive version with hover over if notebook
...
ggsave(filename = file.path("plots", "04_euler.png"), p)
p
...
ggsave(filename = file.path("plots", "04_venn.png"), p)
p
```
