...
combined_dotplot <-
  function(group,
    ...
    p.soleus <- fgsea_dotplot(soleus.df, max_label_length, padj_limits, NES_limits, reorder_by_NES=FALSE)
...
fgsea_dotplot <-
  ...
  # TODO: can't sort this properly
  ggplot(fgseaRes_prep.df,
         # aes(x = ifelse( # is vectorized, does not work
         #   reorder_by_NES, reorder(pathway, NES), pathway
         # ), y = NES)) +
         aes(x = pathway, y = NES)) +
